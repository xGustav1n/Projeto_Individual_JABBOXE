...
function listar(idUsuario) {
    ...
    var instrucao = `
            SELECT nome AS Nome, sobrenome AS Sobrenome, celular AS Celular, sexo AS Sexo, email AS Email FROM usuario WHERE idUsuario = ${idUsuario};
    `;
...
function cadastrar(nome, sobrenome, cel, sexo, email, senha) {
...
function enviarAssunto(emailContato, assunto) {
    console.log("ACESSEI O USUARIO MODEL\n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function enviarAssunto():", emailContato, assunto);
...
function cadastrarCategoria(idade, peso, altura, imcEstado, imcCalculo, categoria, fkUsuario) { 
    console.log("ACESSEI O USUARIO MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function cadastrarCategoria():",idade, peso, altura, imcEstado, imcCalculo, categoria, fkUsuario);
